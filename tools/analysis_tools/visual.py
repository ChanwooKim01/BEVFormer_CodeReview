...
if __name__ == '__main__':
    nusc = NuScenes(version='v1.0-mini', dataroot='/home/chanwoo/AILabDataset/01_Open_Dataset/05_nuScenes/nuScenes', verbose=True)
    render_annotation('7603b030b42a4b1caa8c443ccc1a7d52')
    bevformer_results = mmcv.load('/home/chanwoo/git/mmdetection3d/BEVFormer/test/bevformer_base/Thu_Mar_20_12_57_03_2025/pts_bbox/results_nusc.json')
